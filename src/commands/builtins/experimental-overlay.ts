...
export function showExperimentalDialog(): void {
  ...
  footer.textContent =
    "Tip: use /experimental on <feature>, /experimental off <feature>, /experimental toggle <feature>, /experimental tmux-bridge-url <url>, /experimental tmux-bridge-token <token>, /experimental python-bridge-url <url>, or /experimental python-bridge-token <token>.";
